...
export const getUsers = () => {
	 ...
	 * @summary User login
	 */
	const userLogin = <TData = AxiosResponse<UserFullSchema>>(
	 ...
	 */
	const userProfiles = <TData = AxiosResponse<UserProfiles200>>(
		userIds: null | string[],
		options?: AxiosRequestConfig
	): Promise<TData> => {
	 ...
	 */
	const userEmailConfirmationConfirm = <TData = AxiosResponse<string>>(
	 ...
	 */
	const userEmailVerificationRequest = <TData = AxiosResponse<string>>(
	 ...
	 */
	const userPasswordResetConfirm = <TData = AxiosResponse<string>>(
	 ...
	 */
	const userPasswordResetRequest = <TData = AxiosResponse<string>>(
	 ...
	 */
	const userCreate = <TData = AxiosResponse<UserFullSchema>>(
