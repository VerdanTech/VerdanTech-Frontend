...
export const getGardens = () => {
	 ...
	 */
	const gardenAttributesSet = <TData = AxiosResponse<GardenFullSchema>>(
	 ...
	 */
	const gardenAcceptInvite = <TData = AxiosResponse<GardenMembershipFullSchema>>(
	 ...
	 */
	const gardenChange = <TData = AxiosResponse<GardenMembershipFullSchema>>(
	 ...
	 */
	const gardenInvite = <TData = AxiosResponse<GardenMembershipFullSchema>>(
	 ...
	 */
	const gardenLeave = <TData = AxiosResponse<string>>(
	 ...
	 */
	const gardenRevoke = <TData = AxiosResponse<string>>(
	 ...
	 */
	const gardenCreate = <TData = AxiosResponse<GardenFullSchema>>(
